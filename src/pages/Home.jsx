...
export const Home = () => {
    ...
    const renderRow = (title, data, type) => (
        <div className="my-5">
            ...
            <div className="d-flex flex-row flex-nowrap overflow-auto pb-3" style={{ gap: "1rem" }}>
                {data && data.map((item) => (
                    <div key={item.uid} className="card bg-dark text-light border-secondary" style={{ minWidth: "18rem" }}>
